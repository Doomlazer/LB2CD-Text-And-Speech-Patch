...
;;;				((and (< 59 gX 70) (< 83 gY 143)) (= noun 24))
				((and (< 50 gX 70) (< 93 gY 153)) (= x 60) (= y 143) (= noun 24))
;;;				((and (< 72 gX 84) (< 91 gY 143)) (= noun 25))
				((and (< 70 gX 84) (< 101 gY 153)) (= x 77) (= y 143) (= noun 25))
;;;				((and (< 86 gX 100) (< 93 gY 143)) (= noun 26))
				((and (< 84 gX 100) (< 103 gY 153)) (= x 92) (= y 143) (= noun 26))
;;;				((and (< 103 gX 110) (< 105 gY 134)) (= noun 27))
				((and (< 103 gX 110) (< 115 gY 144)) (= x 106) (= y 134) (= noun 27))
;;;				((and (< 115 gX 130) (< 104 gY 149)) (= noun 28))
				((and (< 112 gX 131) (< 114 gY 159)) (= x 122) (= y 149) (= noun 28))
;;;				((and (< 171 gX 185) (< 96 gY 135)) (= noun 30))
				((and (< 171 gX 185) (< 106 gY 145)) (= x 178) (= y 135) (= noun 30))
;;;				((and (< 187 gX 201) (< 91 gY 137)) (= noun 31))
				((and (< 185 gX 201) (< 101 gY 147)) (= x 193) (= y 137) (= noun 31))
;;;				((and (< 225 gX 256) (< 97 gY 188)) (= noun 32))
				((and (< 220 gX 256) (< 107 gY 198)) (= x 238) (= y 188) (= noun 32))
			)
			; END OF BUGFIX
		)
	)
